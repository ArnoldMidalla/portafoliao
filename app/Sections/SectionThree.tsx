...
export default function SectionThree() {
  ...
  return (
    <div className="max-w-6xl border md:max-w-6xl min-w-full font-dm tracking-tight bg-white">
      {/* change to max-w-208 if bugs */}
      {/* Horizontal scroll container */}
      <div ref={containerRef} className="relative overflow-hidden">
        <div ref={horizontalRef} className="flex h-dvh pl-20 md:px-26 relative">
          {/* Panel 1 */}
